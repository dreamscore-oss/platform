...
import java.io.File;
import com.swagger.client.codegen.rest.model.ModelApiResponse;
...
@Component("com.swagger.client.codegen.rest.api.PetApi")
public class PetApi {
     ...
     * @param body Pet object that needs to be added to the clinic (required)
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void addPet(PetDto body) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Void> addPetWithHttpInfo(PetDto body) throws RestClientException {
        ...
        String[] authNames = new String[] { "petclinic_auth" };
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<PetDto> findPetsByStatus(List<String> status) throws RestClientException {
     ...
     * <p><b>400</b> - Invalid status value
     * @param status Status values that need to be considered for filter (required)
     * @return ResponseEntity&lt;List&lt;PetDto&gt;&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<List<PetDto>> findPetsByStatusWithHttpInfo(List<String> status) throws RestClientException {
        Object postBody = null;
        ...
        ParameterizedTypeReference<List<PetDto>> returnType = new ParameterizedTypeReference<List<PetDto>>() {};
     ...
     * <p><b>200</b> - successful operation
     * <p><b>400</b> - Invalid ID supplied
     * <p><b>404</b> - PetDto not found
     * @param petId ID of pet to return (required)
     * @return PetDto
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public PetDto getPetById(Long petId) throws RestClientException {
     ...
     * <p><b>404</b> - PetDto not found
     * @param petId ID of pet to return (required)
     * @return ResponseEntity&lt;PetDto&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<PetDto> getPetByIdWithHttpInfo(Long petId) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'petId' is set
        if (petId == null) {
        ...
        ParameterizedTypeReference<PetDto> returnType = new ParameterizedTypeReference<PetDto>() {};
        return apiClient.invokeAPI(path, HttpMethod.GET, queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
    }
    /**
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void updatePet(PetDto body) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Void> updatePetWithHttpInfo(PetDto body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
